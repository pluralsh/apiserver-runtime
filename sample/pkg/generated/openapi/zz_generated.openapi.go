...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.Fischer":               schema_pkg_apis_sample_v1alpha1_Fischer(ref),
		"github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.FischerList":           schema_pkg_apis_sample_v1alpha1_FischerList(ref),
		"github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.Flunder":               schema_pkg_apis_sample_v1alpha1_Flunder(ref),
		"github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.FlunderList":           schema_pkg_apis_sample_v1alpha1_FlunderList(ref),
		"github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.FlunderSpec":           schema_pkg_apis_sample_v1alpha1_FlunderSpec(ref),
		"github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.FlunderStatus":         schema_pkg_apis_sample_v1alpha1_FlunderStatus(ref),
		"github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.Fortune":               schema_pkg_apis_sample_v1alpha1_Fortune(ref),
		"github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.FortuneList":           schema_pkg_apis_sample_v1alpha1_FortuneList(ref),
		"github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.fortuneTableConverter": schema_pkg_apis_sample_v1alpha1_fortuneTableConverter(ref),
	}
}
...
func schema_pkg_apis_sample_v1alpha1_FischerList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.Fischer"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.Fischer"},
	}
}
...
func schema_pkg_apis_sample_v1alpha1_Flunder(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.FlunderSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.FlunderStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.FlunderSpec", "github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.FlunderStatus"},
	}
}
...
func schema_pkg_apis_sample_v1alpha1_FlunderList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.Flunder"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.Flunder"},
	}
}
...
func schema_pkg_apis_sample_v1alpha1_FortuneList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.Fortune"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "github.com/pluralsh/apiserver-runtime/sample/pkg/apis/sample/v1alpha1.Fortune"},
	}
}
